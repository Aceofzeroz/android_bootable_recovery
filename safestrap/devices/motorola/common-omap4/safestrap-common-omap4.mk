...
BOARD_DEFAULT_VIRT_SYSTEM_SIZE := 650
BOARD_DEFAULT_VIRT_SYSTEM_MIN_SIZE := 550
BOARD_DEFAULT_VIRT_SYSTEM_MAX_SIZE := 1000
BOARD_DEFAULT_VIRT_DATA_SIZE := 650
BOARD_DEFAULT_VIRT_DATA_MIN_SIZE := 550
BOARD_DEFAULT_VIRT_DATA_MAX_SIZE := 2000
